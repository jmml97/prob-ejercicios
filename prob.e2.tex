...
\begin{sol}
  ...
  Ahora podemos calcular las razones de correlación:
     \begin{align*}
       \eta_{X/Y}^2 = 1 - \frac{ECM(\varphi(Y))}{\operatorname{Var}[X]} = 1 - \frac{ECM(\varphi(Y))}{\operatorname{E}[X^2]-\operatorname{E}[X]^2}
       = 1 - \frac{\frac{13}{12}}{\frac{8}{3}-\left(\frac{3}{2}\right)^2} = \frac{-8}{5} ???
     \end{align*}
     
     \begin{align*}
       \eta_{Y/X}^2 = 1 - \frac{ECM(\psi(X))}{\operatorname{Var}[Y]} = 1 - \frac{ECM(\psi(X))}{\operatorname{E}[Y^2]-\operatorname{E}[Y]^2} = 1 - \frac{\frac{1}{16}}{\frac{1}{3}-\left(\frac{1}{2}\right)^2} = \frac{1}{4} = 0.25
     \end{align*}
     
   La predicción más fiable es la que tiene una mayor razón de correlación.
