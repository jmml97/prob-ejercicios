...
\begin{sol}
  ...
  %   leftmargin=0pt,
  % ]
  %   \item Teniendo en cuenta la región en la que está definido, que podemos ver en la Figura \ref{fig:region}, y sabiendo que se distribuye uniformemente, integramos la función de densidad:
  %   \[
